...
//    private static final String[] BAD = new
//            In("bad.txt").readAllLines();
//    private static final String[] GOOD = new
//            In("good.txt").readAllLines();
//    @BeforeEach
...
//// This test could fail if the two Strings hashed to the
